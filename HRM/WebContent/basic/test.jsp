...
.ui-jqgrid .ui-jqgrid-view input {
    ...
    <aside id="left-panel">
      ...
      <nav>
        <ul style="">
          ...
          <li>
             <a href=""  title="일정관리"><i class="fa fa-calendar"></i> <span class="menu-item-parent" >일정관리</span></a> 
          </li>
          <li>
            <a href="html/list_2_1.html" title="업무명세서" ><i class="fa fa-briefcase"></i> <span class="menu-item-parent">업무명세서</span></a>
          </li>
          <li>
            <a href="html/list_3_1.html" title="근퇴현황"><i class="fa fa-calendar" aria-hidden="true"></i> <span class="menu-item-parent">근퇴현황</span></a>
          </li>
           <li>
         ...
         <!--  <li>
            <a href="" title="설문조사"><i class="fa fa-language" aria-hidden="true"></i> <span class="menu-item-parent">설문조사</span></a>
            <ul>
              <li>
                <a href="html/list_4_1.html"><i class="fa fa-language" aria-hidden="true"></i>진행중인 설문조사</a>
              </li>
              <li>
                <a href="html/list_4_2.html"><i class="fa fa-language" aria-hidden="true"></i>종료된 설문조사</a>
              </li>
            </ul>
          </li> -->
      ...
      <%--     <li>
            ...
            <ul>
              ...
              <li>
                <a href="html/list_8_2.html"><i class="fa fa-lg fa-fw fa-group"></i>부서(조직)관리</a>
              </li>
              <li>
                <a href="html/list_8_3.html"><i class="fa fa-lg fa-fw fa-group"></i>전사조직도</a>
              </li>
              <li>
                <a href="html/list_8_4.html"><i class="fa fa-lg fa-fw fa-archive"></i>인사발령</a>
              </li>
              <li>
    ...
    <div id="main" role="main">
      <div id="ribbon">
       ...
       <div id="div">
      <iframe id="frame" name="frame" src="${root}/user?act=employeeslist" width="1450" height="1000" scrolling="no"></iframe>
      </div >
