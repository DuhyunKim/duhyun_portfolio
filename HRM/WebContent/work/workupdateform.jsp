...
<script type="text/javascript">
	function workUpdateRegister() {
		document.workUpdate.action = "${root}/work?act=workUpdateRegister()";
		document.workUpdate.submit();
	}
	...
	<div class="jarviswidget" id="hr_job_description_add"
		...
		<div role="content">
			<div class="widget-body">
				<form id="workUpdate" name="workUpdate" class="smart-form" method="post" action="" novalidate="novalidate">
					<input type="hidden" name="workSeq" id="workSeq" value="${commonFormList.workSeq }"> 
					<input type="hidden" name="empId" id="empId" value="${commonFormList.empId }">
					...
					<table class="table table-bordered" style="margin-bottom: 10px;">
						<tbody>
							<tr>
								<th nowrap="nowrap" style="background-color: #eee;">사원</th>
								<td><label class="input"> 
								<input type="text" name="empName" id="empName" value="${commonFormList.empName }" disabled="disabled" style="background-color: #eee"> 
								</label></td>
								<th nowrap="nowrap" style="background-color: #eee;">부서</th>
								<td><label class="input"> 
								<input type="text" name="deptName" id="deptName" value="${commonFormList.deptName }" disabled="disabled" style="background-color: #eee"> 
								<input type="hidden" name="deptId" id="deptId" value="">
								</label></td>
								<th width="13%" nowrap="nowrap" style="background-color: #eee;">직급</th>
								<td width="20%"><label class="input"> 
								<input type="text" name="jobName" id="jobName" value="${commonFormList.jobsName }" disabled="disabled" style="background-color: #eee"> 
							...
							<tr>
								...
								<select id="workYear" name="workYear">
										<option value="2017" ${commonFormList.workYear == 2017? 'selected="selected"' : ''}>2017</option>
										<option value="2016" ${commonFormList.workYear == 2016? 'selected="selected"' : ''}>2016</option>
										<option value="2015" ${commonFormList.workYear == 2015? 'selected="selected"' : ''}>2015</option>

								</select> <i></i>
								</label></td>
								<th nowrap="nowrap" style="background-color: #eee;">평가자</th>
								<td><label class="input"> <!-- <div class="select2-container" id="s2id_assessorId"
											style="width: 100%">
										...
										<input type="text" id="workAssessor" name="workAssessor" type="text" value="${commonFormList.assessor }" />
								</label></td>
								<th nowrap="nowrap" style="background-color: #eee;">상태</th>
								<td><label class="select"> <select id="workStatus"
										name="workStatus">
											<option value="저장" ${commonFormList.status == "저장"? 'selected="selected"' : ''}>저장</option>
											<option value="임시저장" ${commonFormList.status == "임시저장"? 'selected="selected"' : ''}>임시저장</option>
									</select> <i></i>
								</label></td>
							</tr>
						</tbody>
					...
					<textarea name="workGoal" id="workGoal" rows="5">${commonFormList.goal }</textarea>
					</label> <br>

					<h6 style="font-weight: bold;">
						<span class="pull-left"> <i
							class="fa fa-chevron-circle-right"></i> 업무 내역
						...
						</span> <input id="contents" name="contents" type="hidden" value="">
					</h6>
					<table class="table table-bordered" style="margin-bottom: 10px;"
						id="breakDown">
						...
						<c:forEach items="${breakDownDtoFormList }" var="vo">
							<tr>
								<td><input type="text" name="breakdownContents[]" value="${vo.breakdownContents2}" /></td>
								<td><input type="text" name="breakdownImportant[]" value="${vo.breakdownImportant2}" /></td>
								<td><input type="text" name="breakdownWeight[]" value="${vo.breakdownWeight2}" /></td>
								<td><input type="text" name="breakdownResult[]" value="${vo.breakdownResult2}" /></td>
								<td><input type="text" name="breakdownCooperation[]" value="${vo.breakdownCooperation2}" /></td>
							</tr>
							<input type="hidden" name="breakdownSeq[]" id="breakdownSeq[]" value="${vo.breakdownSeq2 }" />
							</c:forEach>
					</table>

					<h6 style="font-weight: bold;">
						<span class="pull-left"> <i
							class="fa fa-chevron-circle-right"></i> Periodic Work(주기적인 일)
						</span> <span class="pull-right"> 
						<a href="#" onclick="add_row2()">
						<i class="glyphicon glyphicon-plus"></i></a>
							<a href="#" onclick="delete_row2()">
							<i class="glyphicon glyphicon-minus"></i></a>
						</span> <input id="periodWork" name="periodWork" type="hidden" value="">
					</h6>
					<table class="table table-bordered" style="margin-bottom: 10px;"
						id="periodic">
						<thead class="table-head">
						...
						<c:forEach items="${periodicDtoFormList }" var="vo">
								<tr>
									<td><input type="text" name="periodicPeriod[]" value="${vo.periodicPeriod2}" /></td>
									<td><input type="text" name="periodicContents[]" value="${vo.periodicContents2}" /></td>
									<td><input type="text" name="periodicResult[]" value="${vo.periodicResult2}" /></td>
									<td><input type="text" name="periodicCoopration[]" value="${vo.periodicCoopration2}" /></td>
								</tr>
								<input type="hidden" name="periodicSeq[]" id="periodicSeq[]" value="${vo.periodicSeq2 }" />
							</c:forEach>
						<tbody>
					...
					<h6 style="font-weight: bold;">
						<span class="pull-left"> <i
							class="fa fa-chevron-circle-right"></i> KPI(핵심 성과 지표)
						</span> <span class="pull-right">  <a href="#"
							onclick="add_row3()"><i class="glyphicon glyphicon-plus"></i></a>
							<a href="#" onclick="delete_row3()"><i
								class="glyphicon glyphicon-minus"></i></a>
						</span> <input id="kpi" name="kpi" type="hidden" value="">
					</h6>
					...
					<table class="table table-bordered" style="margin-bottom: 10px;"
						...
						<c:forEach items="${outComeDtoFormList }" var="vo">
								<tr>
									<td><input type="text" name="outcomePeriod[]"
										value="${vo.outcomePeriod2}" /></td>
									<td><input type="text" name="outcomeWork[]"
										value="${vo.outcomeWork2}" /></td>
									<td><input type="text" name="outcomeResult[]"
										value="${vo.outcomeResult2}" /></td>
									<td><input type="text" name="outcomeCooperation[]"
										value="${vo.outcomeCooperation2}" /></td>
								</tr>
								<input type="hidden" name="outcomeSeq[]" id="outcomeSeq[]"
									value="${vo.outcomeSeq2 }" />
							</c:forEach>
					</table>
					...
					<table class="table table-bordered" style="margin-bottom: 10px;"
						id="ablity">
						<tbody>
						<c:forEach items="${ablityDtoFormList }" var="vo">
							<tr>
								<th nowrap="nowrap" style="background-color: #eee;">업무 경력</th>
								<td><label class="textarea"> 
								<textarea id="ablityCareer" name="ablityCareer" rows="3">${vo.ablityCareer}</textarea>
								</label></td>
							</tr>
							<tr>
								<th nowrap="nowrap" style="background-color: #eee;">필요한 학력</th>
								<td><label class="textarea"> <textarea
											id="ablityAcademic" name="ablityAcademic" rows="3">${vo.ablityAcademic}</textarea>
								</label></td>
							</tr>
							<tr>
								<th nowrap="nowrap" style="background-color: #eee;">필요 기술</th>
								<td><label class="textarea"> <textarea
											id="academicSkill" name="academicSkill" rows="3">${vo.academicSkill}</textarea>
								</label></td>
							</tr>
							</c:forEach>
						</tbody>
					...
					<h6 style="font-weight: bold;">
						...
						</span> <span class="pull-right"> <a href="#" onclick="add_row4()"><i
								class="glyphicon glyphicon-plus"></i></a> <a href="#"
							onclick="delete_row4()"><i class="glyphicon glyphicon-minus"></i></a>
						</span> <input id="training" name="training" type="hidden" value="">
					</h6>
					<table class="table table-bordered" style="margin-bottom: 10px;"
						id="education">
						<thead class="table-head">
						...
						<c:forEach items="${educationDtoFormList }" var="vo">
								<tr>
									<td><input type="text" name="eduContents[]"
										value="${vo.eduContents2}" /></td>
									<td><input type="text" name="eduInstitution[]"
										value="${vo.eduInstitution2}" /></td>
									<td><input type="text" name="eduUnusual[]"
										value="${vo.eduUnusual2}" /></td>
								</tr>
								<input type="hidden" name="eduSeq[]" id="eduSeq[]"
									value="${vo.eduSeq2 }" />
							</c:forEach>
						<tbody>
							<tr style="background-color: #eee;"></tr>
					...
					<footer style="background-color:#fff;"> <a href="#"
						class="btn btn-danger btn-sm" onclick="workCancell()">취소</a>
					<button type="submit" class="btn btn-info btn-sm" onclick="workUpdateRegister()">수정</button>
					</footer>
				</form>
			</div>
		</div>
