...
public class PageNavigator {
	private String root;
	private boolean nowFirst;	//현재 페이지가 첫페인지인지
	private boolean nowEnd;		//현재 페이지가 마지막페인지인지
	...
	public void makeNavigator(String menu) {
		StringBuffer tmpNavigator = new StringBuffer();
				
		int listSize = Constance.LIST_SIZE;
		...
		if (this.isNowFirst()) {
//			tmpNavigator.append("  <td><font color='#999999'>\n<a href='javascript:memberlist(1)'>");
			//System.out.println("  <td><font color='#999999'>\n<a href='"+root+"/pboard?act=boardlist&pg=1'>");
			tmpNavigator.append("  <td><font color='#999999'>\n<a href='"+root+"/p"+menu+"?act="+menu+"list&pg=1'>");
			tmpNavigator.append("   <img src='" + root + "/img/icon_prev02.gif' width='7' height='11' border='0' align='absmiddle' hspace='3'>최신목록</a>\n");
...
//			tmpNavigator.append("   <a href='javascript:memberlist(" + preLastNo + ")'>");
			tmpNavigator.append("   <a href='"+root+"/p"+menu+"?act="+menu+"list&pg="+preLastNo+"'>");
			tmpNavigator.append("   <img src='" + root + "/img/icon_prev01_dim.gif' width='3' height='11' border='0' align='absmiddle' hspace='3'>\n");
...
//				tmpNavigator.append("     <td style='padding:0 7 0 7;' nowrap><a href='javascript:memberlist(" + i + ")'>" + i + "</td>\n");
				//System.out.println("     <td style='padding:0 7 0 7;' nowrap><a href='"+root+"/pboard?act=boardlist&pg="+i+"'>" + i + "</td>\n");
				tmpNavigator.append("     <td style='padding:0 7 0 7;' nowrap><a href='"+root+"/p"+menu+"?act="+menu+"list&pg="+i+"'>" + i + "</td>\n");
				tmpNavigator.append("     <td width='1' nowrap><img src='" + root + "/img/n_tab.gif' width='1'");
				tmpNavigator.append(" height='11' border='0' align='absmiddle'><br>\n");
			}
		}
		...
		if (this.isNowEnd()) {
			...
			tmpNavigator.append("   끝목록<img src='" + root + "/img/icon_next02_dim.gif' width='7' height='11'");
			tmpNavigator.append(" border='0' align='absmiddle' hspace='3'></font>\n");
		} else {
			int nextFirstNo = endPage + 1;
//			tmpNavigator.append("   <a href='javascript:memberlist(" + nextFirstNo + ")'>다음<img");
			tmpNavigator.append("   <a href='"+root+"/p"+menu+"?act="+menu+"list&pg="+nextFirstNo+"'>다음<img");
			tmpNavigator.append(" src='" + root + "/img/icon_next01_dim.gif' width='3' height='11'");
			tmpNavigator.append(" border='0' align='absmiddle' hspace='3'></a>\n");
//			tmpNavigator.append("   <a href='javascript:memberlist(" + totalPageCount + ")'>끝목록<img src='" + root + "/img/icon_next02_dim.gif' width='7' height='11'");
			tmpNavigator.append("   <a href='"+root+"/p"+menu+"?act="+menu+"list&pg="+totalPageCount+"'>끝목록<img src='" + root + "/img/icon_next02_dim.gif' width='7' height='11'");
			tmpNavigator.append(" border='0' align='absmiddle' hspace='3'>\n");
		}
