...
public interface WorkService {
	...
	int breakdownDelete(int workSeq, int start, int end);
	int periodicDelete(int workSeq, int start, int end);
	int outcomeDelete(int workSeq, int start, int end);
	int ablityDelete(int workSeq);
	int educationDelete(int workSeq, int start, int end);
