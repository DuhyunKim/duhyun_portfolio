...
public class InsertAction implements Action {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response)
		...
		if(multi.getOriginalFileName("faceImg") != null){
		...
		if(multi.getOriginalFileName("degreeImg") != null){
		...
		if(multi.getOriginalFileName("joinImg") != null){
...
/*		employeesDto.setEmpJobName(request.getParameter("empJobName"));*/
		...
		employeesDto.setAppointId(Integer.parseInt((multi.getParameter("appointId"))));
		employeesDto.setAnniId(Integer.parseInt((multi.getParameter("anniId"))));
		...
		System.out.println("DB insert : "+employeesDto);
		System.out.println("file insert : "+empFileDto);
		
		int cnt =EmployeesServiceImpl.getEmployeeService().insert(employeesDto,empFileDto);
		System.out.println("cnt= "+cnt);
		if(cnt >= 3){
			return "/user?act=employeeslist";
		}else{
			return "/basic/insertfail.jsp";
		}
